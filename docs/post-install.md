...
> [!IMPORTANT]
> This section is not designed to be followed on existing Windows installations. At this stage, you should be booted into the ISO that you created with the steps in [docs/building.md](/docs/building.md). If you have no idea what this means, go back to [docs/pre-install.md](/docs/pre-install.md) and follow the instructions from start to finish.
