...
- Extract the driver executable package with 7-Zip and remove all files **except** the following:
...
- See [CUDA-force-p2-state-analysis.png](../media/cuda-force-p2-state-analysis.png)
